...
#
# print('Min losses ',min_losses[0.2][0].round(2), ', iteration ', min_losses[0.2][1])
#
...
# print('Question 3', rf_score.round(2))
...
# median = data.groupby('cluster').median()
#
...
# pylab.imsave('mean.jpg', mean_image)
#
# medians = data.groupby('cluster').median().values
# median_pixels = [medians[c] for c in data['cluster'].values]
# median_image = np.reshape(median_pixels, (w, h, d))
# pylab.imsave('median.jpg', median_image)
